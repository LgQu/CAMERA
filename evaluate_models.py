...
# flickr
evaluation_models.evalrank_single("pretrain_model/flickr/model_flickr_2.pth.tar", data_path=DATA_PATH, split="test", fold5=False)
...
# coco
# evaluation_models.evalrank_single("pretrain_model/coco/model_coco_2.pth.tar", data_path=DATA_PATH, split="testall", fold5=True)
